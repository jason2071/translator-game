...
/// the rest and ignore the others. Multi-locale engines (Godot translation CSV) use
/// this to pick which source language to translate *from* when a game ships several.
